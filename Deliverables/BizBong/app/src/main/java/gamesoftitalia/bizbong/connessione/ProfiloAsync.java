...
public class ProfiloAsync extends AsyncTask<String, Void, String> {

    private ProgressDialog loadingDialog;
    private Context context;
    private String nickname, modificaNickname, modificaEmail, modificaPassword, confermaPassword;

    public ProfiloAsync(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        if(isNetworkAvailable(context)){
            ...
            try{
                ...
                // Link
                String link = "http://bizbong.altervista.org/php/Control/ProfiloControl.php" + data;
                // Log.d("DEBUG:", link);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result == null) {
            ...
            builder.setPositiveButton("Riprova", new DialogInterface.OnClickListener(){
                ...
                {
                    dialog.dismiss();
                    new LoginAsync(context).execute(nickname, modificaNickname, modificaEmail, modificaPassword, confermaPassword);
                }
            });
