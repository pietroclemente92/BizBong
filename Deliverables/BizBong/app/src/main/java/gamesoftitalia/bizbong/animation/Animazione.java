...
import gamesoftitalia.bizbong.random.Random;
...
class Animazione {
    ...
    public static Animazione create(int width, int height, Paint paint) {
        ...
        return new Animazione(random, position, angle, increment, flakeSize, paint);
    }

    Animazione(Random random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        this.random = random;
